...
public class FRepeatMeshSprite : FMeshNode
{
    ...
    public FRepeatMeshSprite( string elementName, float width, float height, float scrollX, float scrollY ) : base()
    {
        ...
        Init( new FMeshData( FacetType.Quad ), FearsomeMonstrousBeast.atlasManager.GetElementWithName( elementName ) );
    }
    ...
    public void UpdateMesh()
    {
        ...
        {
            rightCol--;
        } //if it fits exactly, we don't need the last column
        ...
        {
            topRow--;
        } //if it fits exactly, we don't need the last row
