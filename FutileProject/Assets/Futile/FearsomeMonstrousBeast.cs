...
public class FearsomeMonstrousBeast : MonoBehaviour
{
    ...
    public FDelayedCallback StartDelayedCallback( Action func, float delayTime )
    {
        ...
        {
            delayTime = 0.00001f;
        } //super small delay for 0 to avoid divide by 0 errors
...
//              }
    ...
    static public void AddStageAtIndex( FStage stageToAdd, int newIndex )
    {
        ...
        {
            return;
        } //if it's already at the right index, just leave it there
